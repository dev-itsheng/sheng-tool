import { camelCase, snakeCase, isPlainObject } from 'lodash-es';
...
/**
 * 将对象中的所有键驼峰化，支持循环引用检查，用于前后端交互（以及后端与数据库交互）时的数据格式转换
 *
 * @param obj 被转换的对象
 *
 * @example
...
/**
 * 将对象中的所有键下划线化，支持循环引用检查，用于前后端交互（以及后端与数据库交互）时的数据格式转换
 *
 * @param obj 被转换的对象
 *
 * @example
